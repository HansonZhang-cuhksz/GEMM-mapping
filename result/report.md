...
### RTX4060 Real (torch.addmm)
| batch B |  mla_o   |  res1  | UNFUSED  | FUSED (S2) |  gain  |
|---------|----------|--------|----------|------------|--------|
| 512     | 5.7702   | 0.0400 | 5.8465   | 5.8982     | 0.9912 |
| 1024    | 11.3962  | 0.2593 | 11.5525  | 11.5112    | 1.0036 |
| 2048    | 22.6896  | 0.5554 | 23.0663  | 22.8559    | 1.0092 |
| 4096    | 45.1517  | 1.0588 | 46.1179  | 45.7236    | 1.0086 |
| 8192    | 90.2871  | 2.0982 | 92.2445  | 91.4575    | 1.0086 |
| 16384   | 180.5948 | 4.2038 | 184.6007 | 183.3934   | 1.0066 |

![](./img/rtx4060_s2_combined.png)

Real fusion gain is related to batch size, and the highest gain appears at 2k-8k batch size.

### Traffic Reduction
Traffic Reduction = 2MN / (MK + KN + 4MN). Increasing batch size (M) would increase traffic reduction percentage.
